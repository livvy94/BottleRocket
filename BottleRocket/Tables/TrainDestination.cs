...

{
    public class TrainDestination
    {
        ...
        public object GenerateTableEntry()
        {
            ...
            string musicBytes = HexHelpers.Reverse(HexHelpers.IntToBinaryString(MusicToPlay, 5));
            string trainStartLocationXBytes = HexHelpers.Reverse(HexHelpers.IntToBinaryString(TrainStartLocationX, 11));
