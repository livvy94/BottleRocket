...
namespace Hex_Serialization_Tests
{
    class TeleportTests
    {
        readonly byte[] location1 = new byte[] { 0xD3, 0x83, 0x86, 0x33, 0x46, 0x51, 0x00, 0x00 };
        readonly byte[] location2 = new byte[] { 0x11, 0x84, 0x86, 0xCA, 0x83, 0x4B, 0x00, 0x00 };
        readonly byte[] location3 = new byte[] { 0x11, 0x84, 0x86, 0xCA, 0x86, 0x4B, 0x00, 0x00 };
        ...
        public void LocationToPointerTableEntry2()
        {
            ...
            Assert.AreEqual(location2, test.TableEntry);
        }
        ...
        public void HexToLocation2()
        {
            ...
            var test = TeleportDestination.ParseHex(location3);
